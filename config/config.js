var config = {
    ...
    welcome: "青青子衿，悠悠我心<br>" +
             "但为君故，沉吟至今<br>",
            //  "你好，我是孟雪，工作四年的老社畜，大家也可以称呼我夕夕<br>" +
            //  "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>你好，我是孟雪，工作四年的老社畜。我期望的工作岗位是需求分析。</p>" +
        "<p>我有着较多的Java编程经验，计算机基础知识掌握扎实，能够在工作中很好的完成自己的任务。此外，我有着充满激情的工作态度，团队协同作战能力强，同时我也具备相应的开发的能力。我的执行力强、责任感高、集体荣誉感强、敢于担当，能够接受加班或出差等安排</p>" +
        "<p>十分期待与您的联系!</p>",
    ...
    */  
     ...
     */
    portfolio: [
        ["./images/pro-1.png", "http://1.15.234.109:8000/", "个人博客", "这里记录了我的一些学习笔记<br>会持续更新"],
